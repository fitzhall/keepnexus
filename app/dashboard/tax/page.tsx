        ...
        <div className="lg:px-6">
          ...
          <div className="px-6 py-6 border-b border-gray-100 bg-gray-50 lg:bg-white lg:border lg:border-gray-300 lg:mb-6">
            <div className="flex items-center justify-between">
              ...
              <Download className="w-6 h-6 text-gray-900 lg:w-8 lg:h-8" />
            </div>
          </div>

          {/* Reports */}
          <div className="flex-1 px-6 py-6 lg:bg-white lg:border lg:border-gray-300 lg:mb-6">
            <h2 className="text-sm font-semibold text-gray-900 mb-4 lg:text-lg">Available Reports</h2>

            <div className="space-y-3">
              <div className="border border-gray-300  p-4 hover:bg-gray-50 transition-colors cursor-pointer lg:p-5">
                <div className="flex items-center justify-between">
