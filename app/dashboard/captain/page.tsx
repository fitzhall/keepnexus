        ...
        <div className="lg:px-6 lg:grid lg:grid-cols-2 lg:gap-6">
          ...
          <div className="flex-1 px-6 py-6 lg:px-0 lg:py-0 lg:col-span-2">
            <div className="space-y-4 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-6">
              <div className="border border-gray-300 p-4 lg:bg-white lg:border lg:border-gray-300 lg:p-6">
                ...
                <button className="text-sm text-gray-900 hover:text-gray-800 lg:text-base">
                  Switch to Desktop →
                </button>
              </div>
              ...
              <div className="border border-gray-300 p-4 lg:bg-white lg:border lg:border-gray-300 lg:p-6">
                ...
                <div className="space-y-2 text-sm text-gray-700 lg:text-base lg:space-y-3">
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked className="" readOnly />
                  </label>
                  <label className="flex items-center justify-between">
